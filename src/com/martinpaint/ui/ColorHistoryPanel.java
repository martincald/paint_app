...
public class ColorHistoryPanel extends VBox {
    ...
    public ColorHistoryPanel(ColorManager colorManager) {
        ...
        HBox header = Panels.panelHeader("SWATCHES");
        ...
        VBox body = new VBox(swatchGrid, recentRow);
    ...
    private Region createSwatch(String hex) {
        ...
        Panels.fixSize(sw, SWATCH_SIZE, SWATCH_SIZE);
    ...
    private void refreshRecent(FlowPane row) {
        ...
        boolean hasRecent = !row.getChildren().isEmpty();
        row.setManaged(hasRecent);
        row.setVisible(hasRecent);
    }
